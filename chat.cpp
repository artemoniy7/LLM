...
int main() {
    ...
    const std::string checkpoint_path = "model.ckpt";
    SimpleTokenizer tokenizer;

    // Параметры модели должны совпадать с train.cpp
    ...
    if (model.load(checkpoint_path)) {
        ...
        std::cout << "No checkpoint found. Using randomly initialized weights.\n";
    }
